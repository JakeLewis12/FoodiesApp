...
namespace FoodiesApp {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class UserLoginDataTable : global::System.Data.TypedTableBase<UserLoginRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UserLoginRow AddUserLoginRow(int Expr1, string Expr2, string Expr3, int UserID, string UserName, string Password) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UserLoginRow FindByExpr1UserID(int Expr1, int UserID) {
        ...
        public partial class UserLoginRow : global::System.Data.DataRow {
            ...
            public int Expr1 {
                get {
                    return ((int)(this[this.tableUserLogin.Expr1Column]));
                }
                set {
                    this[this.tableUserLogin.Expr1Column] = value;
                }
            }
            ...
            public string Expr2 {
                get {
                    return ((string)(this[this.tableUserLogin.Expr2Column]));
                }
                set {
                    this[this.tableUserLogin.Expr2Column] = value;
                }
            }
            ...
            public string Expr3 {
                get {
                    return ((string)(this[this.tableUserLogin.Expr3Column]));
                }
                set {
                    this[this.tableUserLogin.Expr3Column] = value;
                }
            }
...
namespace FoodiesApp.DataSet1TableAdapters {
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT \r\nFROM   UserLogin INNER JOIN\r\n             UserLogin AS UserLogin_1 ON Us" +
                "erLogin.UserID = UserLogin_1.UserID";
    ...
    public partial class UserLoginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [UserLogin] WHERE (([UserID] = @Original_Expr1) AND ([UserName] = @Or" +
                "iginal_Expr2) AND ([Password] = @Original_Expr3) AND ([UserID] = @Original_UserI" +
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [UserLogin] ([UserID], [UserName], [Password], [UserID], [UserName], [Password]) VALUES (@Expr1, @Expr2, @Expr3, @UserID, @UserName, @Password);
SELECT UserID AS Expr1, UserName AS Expr2, Password AS Expr3, UserID, UserName, Password FROM UserLogin WHERE (UserID = @UserID) AND (UserID = @UserID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [UserLogin] SET [UserID] = @Expr1, [UserName] = @Expr2, [Password] = @Expr3, [UserID] = @UserID, [UserName] = @UserName, [Password] = @Password WHERE (([UserID] = @Original_Expr1) AND ([UserName] = @Original_Expr2) AND ([Password] = @Original_Expr3) AND ([UserID] = @Original_UserID) AND ([UserName] = @Original_UserName) AND ([Password] = @Original_Password));
SELECT UserID AS Expr1, UserName AS Expr2, Password AS Expr3, UserID, UserName, Password FROM UserLogin WHERE (UserID = @UserID) AND (UserID = @UserID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT UserID AS Expr1, UserName AS Expr2, Password AS Expr3, UserLogin.*\r\nFROM  " +
                " UserLogin";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        public virtual int Delete(int Original_Expr1, string Original_Expr2, string Original_Expr3, int Original_UserID, string Original_UserName, string Original_Password) {
        ...
        public virtual int Insert(int Expr1, string Expr2, string Expr3, int UserID, string UserName, string Password) {
        ...
        public virtual int Update(int Expr1, string Expr2, string Expr3, int UserID, string UserName, string Password, int Original_Expr1, string Original_Expr2, string Original_Expr3, int Original_UserID, string Original_UserName, string Original_Password) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Expr2, string Expr3, string UserName, string Password, int Original_Expr1, string Original_Expr2, string Original_Expr3, int Original_UserID, string Original_UserName, string Original_Password) {
